    ...
    return (
        <div className="group relative bg-white rounded-2xl border border-aura-pink/10 hover:shadow-xl hover:shadow-aura-pink/5 transition-all duration-500 overflow-hidden">
            <Link 
                ...
                className="block overflow-hidden relative pb-[100%] md:pb-[75%]"
            >
                <img
                    src={product.images?.[0] || "/placeholder.png"}   // FIX HERE 👈
                    alt={product.name}
            ...
            <div className="p-6 text-center">
                <p className="text-[10px] text-aura-pink font-bold uppercase tracking-[0.2em] mb-2">
                    {product.category}
                </p>
                <Link to={`/products/${product._id}`}>
                    <h3 className="text-lg font-serif text-aura-charcoal hover:text-aura-pink transition-colors mb-2 duration-300">
                        {product.name}
                    </h3>
                </Link>
